...
public class ViewSchoolDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_school_details);

        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        existingSchools = new ArrayList<>();

        progress = new ProgressDialog(ViewSchoolDetailsActivity.this);
                    ...
                    dbRef.child(zone).child("furnish/furnishdetail").child(ssv).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NotNull DataSnapshot dataSnapshot) {
                            if (dataSnapshot.exists()) {
                                ...
                                Toast.makeText(ViewSchoolDetailsActivity.this, "No Data", Toast.LENGTH_SHORT).show();
                            }
                        }
