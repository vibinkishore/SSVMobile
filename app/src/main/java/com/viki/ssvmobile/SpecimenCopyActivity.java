...
public class SpecimenCopyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_specimen_copy);
        ...
        progress = new ProgressDialog(SpecimenCopyActivity.this);
        ...
        proceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(getIInputDetails() && calculateNewStock() && calculateDelivery() && pushFinaltoInventory() && updateOrderDetails()) {
                    toHome();
//                    progress.dismiss();
                }
            }
    ...
    private void fetchOrderDetails(String oid) {
        dbRef.child(zone + "/order/" + oid + "/speciments").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
    ...
    private boolean updateOrderDetails() {
        ...
        dbRef.child(zone + "/order/" + orderId).child("speciments").updateChildren(orderMapRef).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
