...
public class AdminPaymentsActivity extends AppCompatActivity {
    ...
    Spinner selectZone;
    String zone;
    String orderid,schoolName,orderTotal,paidamt,deliveredamt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress = new ProgressDialog(AdminPaymentsActivity.this);
        ...
        fetchOrderData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!zone.equals("Select Zone")) {
                    ...
                    Toast.makeText(AdminPaymentsActivity.this, "Select a Zone", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
        ...
        dbRef.child(selectedZone).child("order").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot ds, @Nullable String s) {
                ...
                if (ds.exists()) {
                    ...
                    orderid = ds.getKey();
                    orderTotal = ds.child("orderamt/orderamt").getValue(String.class);
                    paidamt = ds.child("paidamt/paidamt").getValue(String.class);
                    deliveredamt = ds.child("deliveryamt/deliveryamt").getValue(String.class);

                    arrayList.add("Order Id:\t" + orderid
                            + "\nSchool:\t" + schoolName
                            + "\nOrder Total:\t" + orderTotal
                            + "\nDelivered Amount:\t" + deliveredamt
                            + "\nPaid Amount:\t" + paidamt + "\n");
                    arrayAdapter.notifyDataSetChanged();
                } else {
                    Toast.makeText(AdminPaymentsActivity.this, "No Data", Toast.LENGTH_SHORT).show();
                }
