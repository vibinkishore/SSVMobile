...
public class ReturnBooksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress = new ProgressDialog(ReturnBooksActivity.this);
...
//                    progress.dismiss();
    ...
    private void pushDeliveryTotal() {
        ...
        dbRef.child(zone + "/order/" + orderId).child("deliveryamt").setValue(delValue);
    }
    ...
    private  void setPrevDelVal()
    {
        dbRef.child(zone + "/order/" + orderId+"/deliveryamt").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(ReturnBooksActivity.this, String.valueOf(prevDelVal), Toast.LENGTH_SHORT).show();
    ...
    private void fetchOrderDetails(String oid) {
        ...
        dbRef.child(zone + "/order/" + oid).child("return").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                pd_computerBasics = Integer.parseInt(dataSnapshot.child("computerBasics").getValue(String.class).toString());
                pd_cProgramming = Integer.parseInt(dataSnapshot.child("CProgramming").getValue(String.class).toString());
    ...
    private boolean updateOrderDetails() {
        ...
        dbRef.child(zone + "/order/" + orderId).child("return").setValue(orderMapRef).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
